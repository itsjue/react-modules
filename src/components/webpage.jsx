    ...
    <section id="faq">
      ...
      <Accordion.Root type="single" collapsible defaultValue={"item-1"}>
          <Accordion.Item value="item-1">
              ...
              <Accordion.ItemContent>
                <Accordion.ItemBody>
                  ...
                  perfect blend of creativity and functionality, setting them
                  apart from the competition. We constantly strive to push the
                  boundaries of what's possible to deliver a truly exceptional
                  user experience.
                </Accordion.ItemBody>
                <br />
              </Accordion.ItemContent>
          ...
          <Accordion.Item value="item-2">
              ...
              <Accordion.ItemContent>
                <Accordion.ItemBody>
                  A: XYZ Company is committed to environmental responsibility.
                  We implement eco-friendly practices throughout our production
                  process, from sourcing materials to manufacturing. Our
                  dedication to sustainability extends beyond our products, as
                  we actively engage in initiatives to reduce our carbon
          ...
          <Accordion.Item value="item-3">
              <Accordion.ItemTrigger>
                <Span flex="1">
                  <strong>
                    Q: What kind of support can customers expect from XYZ
              ...
              <Accordion.ItemContent>
                <Accordion.ItemBody>
                  A: At XYZ Company, customer satisfaction is our top priority.
                  Our dedicated support team is available 24/7 to address any
                  inquiries or concerns you may have. Whether you need
                  assistance with product usage, troubleshooting, or general
                  information, our knowledgeable and friendly customer service
                  representatives are always ready to provide prompt and
                  effective support.
                </Accordion.ItemBody>
                <br />
              </Accordion.ItemContent>
          ...
          <Accordion.Item value="item-4">
              ...
              <Accordion.ItemContent>
                <Accordion.ItemBody>
                  ...
                  through continuous research and development. We invest heavily
                  in staying ahead of the curve, monitoring market dynamics, and
                  actively seeking feedback from our customers. By embracing
                  innovation and staying agile, we ensure that our products and
                  services evolve to meet the ever-changing needs of our dynamic
                  customer base.
                </Accordion.ItemBody>
                <br />
              </Accordion.ItemContent>
          ...
          <Accordion.Item value="item-5">
              ...
              communities we serve. We actively engage in philanthropic
              initiatives, supporting local charities and community projects.
              Additionally, we encourage our employees to participate in
              volunteer programs, fostering a culture of social responsibility.
              By being actively involved in the community, we aim to make a
              positive impact beyond the products and services we offer.
              </Accordion.ItemBody>
              <br />
              </Accordion.ItemContent>
          </Accordion.Item>
